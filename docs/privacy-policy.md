...
- User content: recipe notes, created recipes, bookmarks, and saved preferences.
...
- Contacts.
- Photos or media outside of user-chosen recipe images.

## How data is used
- To authenticate users and keep them signed in.
- To store and sync recipes, bookmarks, and notes.
